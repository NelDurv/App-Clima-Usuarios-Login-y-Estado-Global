    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div class="d-flex gap-2">
        <button 
          ...
          class="btn"
          :class="isFavoriteCity ? 'btn-danger' : 'btn-outline-danger'"
          @click="toggleFavorite"
        >
          <i :class="isFavoriteCity ? 'fas fa-heart' : 'far fa-heart'"></i>
          {{ isFavoriteCity ? 'Eliminar de favoritos' : 'Agregar a favoritos' }}
        </button>
...
const isFavoriteCity = computed(() => favorites.value.includes(nombreCiudad.value))
...
const toggleFavorite = () => {
  if (isFavoriteCity.value) {
    store.dispatch('auth/removeFavorite', nombreCiudad.value)
  } else {
    store.dispatch('auth/addFavorite', nombreCiudad.value)
  }
}
